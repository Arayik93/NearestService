...
@RealmClass
public class BeautySalon implements RealmModel, Service {
    ...
    public void saveInDatabase(String name, String description, String address, double latitude, double longitude) {
        BeautySalon service = new BeautySalon();
        ...
        service.setRating("0");
        service.setImageResource(R.drawable.markerbeautysalon);
        service.setCategoryId(MainActivity.BEAUTY_SALON_INDEX);
