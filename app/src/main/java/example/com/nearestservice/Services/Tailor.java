...
@RealmClass
public class Tailor implements RealmModel, Service {
    ...
    public void saveInDatabase(String name, String description, String address, double latitude, double longitude) {
        ...
        service.setRating("0");
        service.setImageResource(R.drawable.markertailor);
        service.setCategoryId(MainActivity.TAILOR_INDEX);
